...
class BookIdentifier:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('BookIdentifier')
...
class BookChecksum:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('BookChecksum')
...
class BookMeta:
  ...
  thrift_spec = (
    ...
    (16, TType.STRUCT, 'book_identifiers', (BookIdentifier, BookIdentifier.thrift_spec), None, ), # 16
    ...
    (28, TType.STRUCT, 'file_checksums', (BookChecksum, BookChecksum.thrift_spec), None, ), # 28
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRUCT:
          self.book_identifiers = BookIdentifier()
        ...
        if ftype == TType.STRUCT:
          self.file_checksums = BookChecksum()
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('BookMeta')
...
class BookStorage:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('BookStorage')
    oprot.writeFieldStop()
    oprot.writeStructEnd()
